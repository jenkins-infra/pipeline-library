...
=== HowTo test a pull request change

By adding `@Library('pipeline-library@pull/<your-pr-number>/head') _` to the top of a Jenkinsfile from a repository builded on one of the *.ci.jenkins.io instances, you can test in situ your pipeline library pull request.
